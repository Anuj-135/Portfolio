...
export default function Contact({ darkMode }) {
  ...
  const canvasBg = d ? '#13132a' : '#fafafe'
  const hintColor = d ? 'rgba(255,255,255,0.4)' : 'rgba(108,99,255,0.4)'
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div style={reveal(0)} className="mb-10 sm:mb-14">
          ...
          <p style={{ fontSize: 14, color: muted, marginTop: 10, maxWidth: 500, lineHeight: 1.7 }}>
            Reach out through any of the links — or just doodle something on the canvas below. 🎨
          </p>
        </div>
